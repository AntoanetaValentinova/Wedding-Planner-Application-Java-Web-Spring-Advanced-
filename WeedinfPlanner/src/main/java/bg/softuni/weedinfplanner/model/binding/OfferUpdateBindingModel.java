...
public class OfferUpdateBindingModel {
    ...
    public OfferUpdateBindingModel setTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public OfferUpdateBindingModel setAbout(String about) {
        this.about = about;
        return this;
    }
    ...
    public OfferUpdateBindingModel setMinPrice(BigDecimal minPrice) {
    ...
    public OfferUpdateBindingModel setMaxPrice(BigDecimal maxPrice) {
    ...
    public OfferUpdateBindingModel setKmCoverageFromAddress(Integer kmCoverageFromAddress) {
    ...
    public OfferUpdateBindingModel setPhoneNumber(String phoneNumber) {
